...
if (($_POST["place_lat"] != "") && ($_POST["place_lang"] != "")) {
        ...
        echo $user_query = "SELECT (3959 * acos (
        ...
        //$user_query = "SELECT first_name, last_name, email, imgurl, profile_id FROM userdetails ORDER BY first_name DESC";
        ...
        if (mysqli_num_rows($query) > 0) {
            while($res = mysqli_fetch_array($query)){
                ...
                $user_list[] = array("first_name" => $first_name, "last_name" => $last_name, "email" => $email, "profile_id" => $profile_id, "imgurl" => $imgurl);
            }
